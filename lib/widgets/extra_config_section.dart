...
class _ExtraConfigSectionState extends State<ExtraConfigSection> {
  ...
  void initState() {
    ...
    _profitsThresholdController =
        TextEditingController(text: widget.profitsThreshold.toStringAsFixed(3));
    _profitsTakePercentController =
        TextEditingController(text: widget.profitsTakePercent.toStringAsFixed(2));
    _usdAllocationController =
        TextEditingController(text: widget.usdAllocation.toStringAsFixed(3));
    _maxTokenMarketPriceController =
        TextEditingController(text: widget.maxTokenMarketPrice.toStringAsFixed(2));
  }
  ...
  void _handleFieldChange() {
    if (_validateForm()) {
      ...
      widget.onProfitsThresholdChanged(double.parse(_profitsThresholdController.text));
      widget.onProfitsTakePercentChanged(
          double.parse(_profitsTakePercentController.text));
      widget.onUsdAllocationChanged(double.parse(_usdAllocationController.text));
      widget.onMaxTokenMarketPriceChanged(
          double.parse(_maxTokenMarketPriceController.text));
    }
  }
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: 'Profits Threshold',
                  border: OutlineInputBorder(),
                ),
                keyboardType: TextInputType.numberWithOptions(decimal: true),
                validator: validateProfitsThreshold,
              ),
              SizedBox(height: 16),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: 'Profits Take %',
                  border: OutlineInputBorder(),
                ),
                keyboardType: TextInputType.numberWithOptions(decimal: true),
                validator: validateProfitsTakePercent,
              ),
              SizedBox(height: 16),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: 'USD Allocation',
                  border: OutlineInputBorder(),
                ),
                keyboardType: TextInputType.numberWithOptions(decimal: true),
                validator: validateUsdAllocation,
              ),
              SizedBox(height: 16),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: 'Max Token Market Price',
                  border: OutlineInputBorder(),
                ),
                keyboardType: TextInputType.numberWithOptions(decimal: true),
                validator: validateMaxTokenMarketPrice,
              ),
            ],
          ),
        ),
